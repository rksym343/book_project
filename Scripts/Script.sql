...
INSERT INTO book_project.bookInfo(b_code, b_sub_code, c_name,b_name,author,p_code, price,insert_date) values
...
INSERT INTO book_project.memberInfo (m_code, m_name, m_tel, m_zip_code, m_address, is_secsn, m_pass, m_group) VALUES
('C001', '김유정', '010-1111-1234',04524,'서울특별시 중구 세종대로 110',false, '1234', 'C'),
('C002', '박보영', '010-1234-2255',35242,'대전광역시 서구 둔산로 100',false, '4567', 'C'), 
('C003', '박보영', '010-2222-4567',41911,'대구광역시 중구 공평로 88',false, '5864', 'C'),
('C004', '전지현', '010-7777-2255',47545,'부산광역시 연제구 중앙대로 1001',false, 'aaba', 'C'),
('C005', 'Emma Watson', '010-5555-4567',41908,'대구광역시 중구 국채보상로139길 1',false, 'bbbb', 'C'),
('C006', '고수', '010-1234-1234',41185,'대구광역시 동구 아양로 207',true, '8888', 'C'), -- 탈퇴상태
('C007', '박보검', '010-5432-1234',41777,'대구광역시 서구 국채보상로 257',false, '9595', 'C'),
('C008', '박형식', '010-1234-9999',42429,'대구광역시 남구 이천로 51',false, '5555', 'C'),
('C009', 'Dan Stevens', '010-9876-1200',41590,'대구광역시 북구 옥산로 65',false, '4444', 'C'),
('C010', '원빈', '010-9876-5432',42424,'대구 남구 중앙대로 220 3층',false, '8811', 'C'),
('C050', '원빈', '010-234-1234',42424,'대구 남구 중앙대로 220 3층',false, '8811', 'C');




-- m_lend_count 수정 : 자료 추가후 수정이 없었음
INSERT INTO book_project.memberLend (m_code, is_posbl, delay_count, m_lend_count, m_now_count, black_date)VALUES
('C001', true, 0, 2, 2, null),
('C002', true, 1, 2, 2, null),
('C003', true, 0, 4, 1, null),		
('C004', true, 0, 5, 4, null),					-- 4권 빌린사람
('C005', false, 1, 7, 5, null),				-- 5권 빌린사람
('C006', false, 0, 1, 0, null),				-- 탈퇴회원
('C007', false, 1, 3, 1, null),				-- 책 연체 중인 사람(일반)
('C008', true, 2, 4, 2, null),					-- 곧 블랙.. 연체횟수 2번이나 연체중 아님
('C009', false, 2, 6, 2, null), 				-- 곧 블랙리스트 될 사람.. 연체횟수2번에 연체중인사람
('C010', false, 3, 5, 0, '2017-03-23'); 		-- 현재 블랙리스트
